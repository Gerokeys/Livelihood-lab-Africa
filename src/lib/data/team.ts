...
export const team: TeamMember[] = [
  ...
  },
  {
    ...
    initials: "JM",
    bio: "Jack manages the firm's programme operations, project delivery, and field implementation. He brings hands-on experience in livelihoods programming, food systems, enterprise development, and community-based project management across Kenya and the Horn of Africa.",
    expertise: [
